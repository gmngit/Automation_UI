...
from exam_srv import db, bcrypt
from exam_srv.models.token_blacklist import BlacklistedToken
from exam_srv.util.datetime_util import utc_now, get_local_utcoffset, make_tzaware, localized_dt_string
from exam_srv.util.result import Result
...
class User(db.Model):
    ...
    def encode_access_token(self):
        ...
        if current_app.config["TESTING"]:
            expire = now + timedelta(minutes=token_age_m, seconds=5)
